...
window.onload = function () {
    ...
    const serializedData = localStorage.getItem('sudoku');
    if (serializedData) {
        const { board, solution } = JSON.parse(serializedData);
        if (confirm("You have saved a Sudoku puzzle, would you like to continue?")) {
